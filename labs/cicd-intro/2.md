...
Let's see the output in the Kubernetes UI, available at: [http://10.10.20.21:8001/api/v1/namespaces/kube-system/services/kubernetes-dashboard/proxy/#!/workload?namespace=default](). As you can see from the message, you cannot log in from your local computer, you need to be logged into the DevBox with RDP to access the Kubernetes UI.

![](assets/images/k8slogin.png)

First, you must log in using a Kubeconfig file. This file is available at the root of the DevBox in `/home/developer/admin.conf`. 
