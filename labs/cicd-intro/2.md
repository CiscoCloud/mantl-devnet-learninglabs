...
Due to the current CICD Sandbox setup, there is no route from your VPN client to the Kubernetes workloads, so we'll have to see our app by SSH'ing to one of the servers in the Sandbox.
