...
You may think that this is a lot of configuration, but Drone actually gets all of its instructions from a configuration file stored *INSIDE* your code repository. That configuration file lets a single drone server handle completely different scenarios from many teams and repositories.
