...
Let's see the output in the Kubernetes UI, available at: [ http://10.10.20.21:8001/api/v1/namespaces/kube-system/services/kubernetes-dashboard/proxy/]()
