...
1. Navigate to [play-with-docker.com](http://labs.play-with-docker.com/) in a browser. A **Play with Docker** page is displayed.
2. In the **Play with Docker** page, choose **docker** from the **Login** drop-down list as shown below. A **Welcome Back** page is displayed.
    ![](assets/images/login-docker.png)
3. In the **Welcome Back** page, enter the **Docker ID**, **Password**, and then click **Sign In**. A **Play with Docker** page is displayed.
