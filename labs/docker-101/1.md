...
1. Navigate to [play-with-docker.com](http://labs.play-with-docker.com/) site in a browser. The **Play with Docker** screen is displayed with **Login** button.
   ![](assets/images/docker-login1.png) 
2. Click **Login** and select **docker**. The **Sign-in** page is displayed.
