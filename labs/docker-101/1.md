...
1. Navigate to [play-with-docker.com](http://labs.play-with-docker.com/) site in a browser. The **Play with Docker** page is displayed.
2. In the **Play with Docker** page, click **Login** and select **docker**. The **Sign-in** page is displayed.
   ![](assets/images/docker-login1.png)
3. In the **Sign-in** page, enter the **Docker ID**, **Password**, and then click **Sign In**. The **Play with Docker** page is displayed.
     ![](assets/images/login2.png)
4. In the **Play with Docker** page, click **Start** and continue to play-with-docker.com.  A page is displayed with a session countdown and an __ADD NEW INSTANCE__ button.
