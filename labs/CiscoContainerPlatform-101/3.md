...
The Kubernetes deployment manifest for our OwnCloud application is here: [Open me in a new tab and copy the whole page to the clipboard.](https://learninglabs.cisco.com/posts/files/CiscoContainerPlatform-101/assets/kube-manifests/owncloud.json)
